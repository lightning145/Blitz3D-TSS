...
PANGO_AVAILABLE_IN_ALL
void __cdecl   pango_layout_set_text       (PangoLayout    *layout,
					    const char     *text,
					    int             length);
PANGO_AVAILABLE_IN_ALL
...
PANGO_AVAILABLE_IN_ALL
void _cdecl    pango_layout_set_font_description (PangoLayout                *layout,
...
void     pango_layout_get_pixel_extents    (PangoLayout    *layout,
					    ...
					    PangoRectangle *logical_rect);
PANGO_AVAILABLE_IN_ALL
void __cdecl    pango_layout_get_size             (PangoLayout    *layout,
					    int            *width,
					    int            *height);
PANGO_AVAILABLE_IN_ALL
...
int _cdecl  pango_layout_get_baseline         (PangoLayout    *layout);
