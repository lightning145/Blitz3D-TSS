...
PangoLayout * __cdecl pango_cairo_create_layout (cairo_t     *cr);
PANGO_AVAILABLE_IN_1_10
void __cdecl  pango_cairo_update_layout (cairo_t     *cr,
					PangoLayout *layout);
...
PANGO_AVAILABLE_IN_1_10
void __cdecl pango_cairo_show_layout       (cairo_t          *cr,
				    PangoLayout      *layout);
