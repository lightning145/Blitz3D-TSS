...
"uniform bool UseDirection = false;\n"
...
"       if(UseDirection) {\n"
"          LightDir = normalize(-1.0 * LightDirectional);\n"
"       }\n"
...
"  vec3 skinnedNormal = normalize(aNormal);\n"
"  vec3 skinnedTangent = normalize(aTangent);\n"
"  vec3 skinnedBitangent = normalize(aBitangent);\n"
